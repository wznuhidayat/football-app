    ...
    <div class="container mx-auto px-6">
      <div class="lg:flex lg:justify-around py-5">
        <div class="text-white text-center mb-5 ">
          <h2 class="text-lg mb-4">Thank To</h2>
          <ul class="text-sm">
            <li>Pinterest</li>
            <li>Youtube</li>
            <li>Google</li>
        ...
        <div class="text-white text-center mb-5">
          <h2 class="text-lg mb-4">Technology</h2>
          <ul class="text-sm">
            <li>Laravel 9</li>
            <li>Tailwindcss</li>
            <li>Rapid API</li>
        ...
        <div class="text-white text-center mb-5">
          <h2 class="text-lg mb-4">Contact Creator</h2>
          <ul class="text-sm">
            <li>Website</li>
            <li>Instagram</li>
            <li>Facebook</li>
      ...
      <div class="mx-auto text-center text-white mt-4 text-sm">
