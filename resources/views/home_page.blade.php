...
<section class="h-[400px] md:h-[700px] bg-gradient-to-b from-gray-700 to-gray-900 py-32 md:py-64">
    <div class="container mx-auto px-6 ">
      <h1 class="text-3xl md:text-5xl font-bold text-white text-center duration-300 animate-fade-in-up">Best League In The World</h1>
      <h2 class="text-lg md:text-2xl  font-medium text-white text-center mt-4 duration-300 animate-fade-in-up-1">the most intense competition in which there are the best clubs in the world</h2>
      <div class="flex justify-center mt-4">
        <button class="px-10 py-2 bg-transparent border-solid border border-white text-white rounded-lg text-sm hover:bg-slate-100 hover:text-gray-900 animate__bounceIn">Join Us</button>
      </div>
    </div>
  </section>
  ...
  <section class="py-4">
    <div class="container mx-auto px-6">
      <div class="flex justify-between">
        <h2 class="text-xl mb-4 js-scroll opacity-0 duration-300">Last Match</h2>
        <a href="" class="js-scroll opacity-0 duration-300">View More</a>
      </div>
  ...
  <section class="my-10">
    <div class="container mx-auto px-6">
      <div class="mb-8">
        <h1 class="text-center text-lg md:text-2xl font-bold  js-scroll opacity-0 duration-500">Last Premier League Winner</h1>
      </div>
          ...
          <div class="flex justify-between">
            <div class="flex items-center">
              <div class="logo px-5 py-10">
                <img src="{{ asset('images/mc-logo.png') }}" alt="" class="inline object-cover w-16 h-16 ">
              </div>
              <div>
          ...
          <table class="table-auto w-full mt-5">
            ...
            <tbody class="">
              <tr class="bg-gray-200">
                ...
                <td class="p-3 text-sm md:text-md "><img src="{{ asset('images/mc-logo.png') }}" alt="" class="inline object-cover w-8 h-8 ml-8"></td>
              ...
              <tr class="bg-gray-200">
                ...
                <td class="p-3 text-sm md:text-md "><img src="{{ asset('images/lvp-logo.png') }}" alt="" class="inline object-cover w-8 h-8 ml-8"></td>
              ...
              <tr class="bg-gray-200">
                ...
                <td class="p-3 text-sm md:text-md "><img src="{{ asset('images/cfc-logo.png') }}" alt="" class="inline object-cover w-8 h-8 ml-8"></td>
              ...
              <tr class="bg-gray-200">
                ...
                <td class="p-3 text-sm md:text-md "><img src="{{ asset('images/lc-logo.png') }}" alt="" class="inline object-cover w-8 h-8 ml-8"></td>
  ...
  <section class="h-[450px] md:h-[600px] bg-gradient-to-b from-gray-700 to-gray-900 py-10 lg:py-24">
    <div class="container mx-auto px-10 py-5 lg:px-48 lg:py-10">
      <h1 class="text-xl md:text-2xl font-bold mb-4 text-white text-center md:text-left js-scroll opacity-0 duration-500">No Room For Racism</h1>
      <p class="tracking-wide text-sm md:text-md text-white js-scroll opacity-0 duration-500">There is No Room For Racism. Anywhere. <br>
  ...
  <section>
    <div class="container mx-auto px-6 py-10">
      ...
      <div class="mb-8 mt-10">
        <h1 class="text-lg md:text-2xl font-bold text-right js-scroll opacity-0 duration-500">Relegation Team Last Season</h1>
      </div>
      <div class="flex justify-around w-full bg-slate-100 rounded-xl p-5 js-scroll opacity-0 duration-500">
        <div class="px-5 py-4">
